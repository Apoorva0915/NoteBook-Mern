  ...
  return (
    <>
            ...
            <div className="modal-body">
              <form className="my-3">
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" id="etitle" name="etitle" value={note.etitle} aria-describedby="emailHelp" onChange={onChange} minLength={8} required />
                </div>
                <div className="mb-3">
      ...
      <div className="row my-3">
        ...
        {notes.map((notes) => {
          return <NotesItem key={notes._id} updateNote={updateNote} showAlert={props.showAlert} notes={notes} />;
        })}
      </div>
    </>
  )
